...
# or when linking avigst a specific BerkelyDB version: BDB_LIB_SUFFIX=-4.8
...
!win32 {
# for extra security avigst potential buffer overflows: enable GCCs Stack Smashing Protection
